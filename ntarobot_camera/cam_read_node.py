...
class CameraNode(LifecycleNode):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameters(
            namespace = "",
            parameters = [
                ("topic_img", "/color/image_raw/compressed"), # Topico para imagen comprimida
    ...
    def callBackImage(self, msg: CompressedImage) -> None:
        # Validacion de ejecucion de nodo por medio de servicio
        if self.enable:

            # Descompresion de imagen
            cv_img = self.cv_bridge_var.compressed_imgmsg_to_cv2(msg)
...
def main():
    ...
    camera_node.trigger_configure()
    camera_node.trigger_activate()
